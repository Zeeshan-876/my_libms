<nav aria-label="Main">
     <ul class="nav flex-column mt-2 has-active-border active-on-top">
                                   ...
                                   <span>
                                        ...
                                        <div class="sidebar-section-item pt-2 fadeable-left fadeable-top">
                                             <div class="fadeinable">
                                                  <img alt="Natalie's avatar" src="assets/image/avatar/avatar3.jpg"
                                                       width="48" class="p-2px border-2 brc-primary-tp2 radius-round" />
                                             </div>

                                             <div class="fadeable hideable">
                                                  <div class="py-2 d-flex flex-column align-items-center">
                                                       @auth
                                                       <img alt="Natalie's avatar" src="assets/image/avatar/avatar.png"
                                                       ...
                                                       @guest
                                                       <img alt="Natalie's avatar" src="assets/image/avatar/avatar2.png"
                                                            class="p-2px border-2 brc-primary-m2 radius-round" />
          ...
          <li class="nav-item {{isset($menu) ? ($menu=='system_setting' ? 'active open' : '') : ''}}">
               <a href="#" id="system_setting"
                    class="nav-link dropdown-toggle {{isset($menu) ? ($menu=='system_setting' ? '' : 'collapsed') : 'collapsed'}}">
                    <i class="nav-icon fa fa-cube"></i>
                    <span class="nav-text fadeable">
